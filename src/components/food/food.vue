      ...
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :only-content="onlyContent"
                        ...
                        @select="select" @toogleContent="toogleContent"></ratingselect>
  ...
  export default {
    ...
    methods: {
      show() {
        ...
        this.$nextTick(() => {
          if (!this.scroll) {
            this.scroll = new IScroll(this.$refs.food, {click: true, mouseWheel: true});
          } else {
            this.scroll.refresh();
          }
        });
      ...
      addFirst(event) {
        this.$emit('increase', {food: this.food, el: event.target});
      },
      select(type) {
